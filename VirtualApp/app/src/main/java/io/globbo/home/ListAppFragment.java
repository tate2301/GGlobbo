...
import io.globbo.abs.ui.VFragment;
import io.globbo.home.adapters.CloneAppListAdapter;
import io.globbo.home.models.AppInfo;
import io.globbo.home.models.AppInfoLite;
import io.globbo.sys.Installd;
import io.globbo.widgets.DragSelectRecyclerView;
...
public class ListAppFragment extends VFragment<ListAppContract.ListAppPresenter> implements ListAppContract.ListAppView {
    ...
    private void chooseInstallWay(Runnable runnable, String path) {
        AlertDialog alertDialog = new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton(R.string.install_choose_Soterio, (dialog, which) -> {
                    ...
                    try {
                        ...
                        AlertDialog showInstallDialog = new AlertDialog.Builder(getContext())
                                ...
                                .setMessage(R.string.install_Soterio_not_exist)
                        ...
                        AlertDialog showInstallDialog = new AlertDialog.Builder(getContext())
                                .setTitle(android.R.string.dialog_alert_title)
                                .setMessage(R.string.install_Soterio_while_old_version)
