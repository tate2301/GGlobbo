...
import io.globbo.R;
import io.globbo.VCommends;
import io.globbo.gms.FakeGms;
import io.globbo.home.ListAppActivity;
import io.globbo.utils.Misc;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            moduleManage.setOnPreferenceClickListener(preference -> {
                try {
                    ...
                    if (ret < 0) {
                        Toast.makeText(getActivity(), "GlobboGlobbo installer not found", Toast.LENGTH_SHORT).show();
                    }
